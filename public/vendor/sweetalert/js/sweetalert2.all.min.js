...
!(function (t, e) {
        ...
        (function (t, e, n) {
          ...
          xt(o, "confirm", n),
            ...
            (function (t, e, n, o) {
              ...
              at([t, e, n], C.styled),
                o.confirmButtonColor && ((t.style.backgroundColor = o.confirmButtonColor), at(t, C["default-outline"]))
  ...
  var Ot = { innerParams: new WeakMap(), domCache: new WeakMap() },
    ...
    Vt = function (t, e) {
      ;["string", "number"].includes(o(e))
        ? (t.value = "".concat(e))
        : j(e) || B('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(o(e), '"'))
    },
    _t = {}
  ;(_t.text =
    _t.email =
    ...
    Oe = function (t, e) {
      ...
      if (n) {
        ...
        O(e.inputOptions) || j(e.inputOptions)
          ...
          ? i(e.inputOptions)
          : P("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(o(e.inputOptions)))
      }
    },
    Le = function (t, e) {
      var n = t.getInput()
          ...
          "object" !== o(t[0]) || An(t[0])
            ? ["title", "html", "icon"].forEach(function (n, i) {
                ...
                "string" == typeof r || An(r)
                  ? (e[n] = r)
                  : void 0 !== r &&
                    P("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ').concat(o(r)))
              })
            : Object.assign(e, t[0]),
          e
        )
  ...
  function Yn(t) {
    !(function (t) {
      t.inputValidator ||
        ("email" === t.input && (t.inputValidator = Kn.email), "url" === t.input && (t.inputValidator = Kn.url))
    })(t),
